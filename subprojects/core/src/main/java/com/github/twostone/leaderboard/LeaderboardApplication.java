...
public class LeaderboardApplication {
    ...
    @Bean
    public CommandLineRunner demo(CompetitionRepository competitionRepository, AthleteRepository athleteRepository) {
    	return (args) -> {
    		Athlete athlete = athleteRepository.save(new Athlete("Niklas", "Walter", LocalDate.of(1987, 12, 5)));
    		
    		Competition competition = competitionRepository.save(new Competition("Comp 1", LocalDate.of(2015, 12, 24)));
